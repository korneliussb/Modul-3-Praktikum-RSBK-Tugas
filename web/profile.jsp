<%-- 
    Document   : home
    Created on : Nov 5, 2019, 10:12:56 AM
    Author     : korneliussb
--%>
...
<div class="container col-lg-4 col-md-4 col-sm-4 col-xs-4">              
    ...
    <div class="panel-body text-center">   
        <br>
        <p style="font-family:arial; font-size:24px; color:white;">TUGAS MODUL 3 PRAKTIKUM RSBK 2019</p>
        <br>
        <img src="img/profile.jpg" style="width:200px;border-radius:5px;">
        <br><br>
        <h3 style="color:white; color:window; font-family: arial; font-size: 20">Kornelius Satria B</h3>
        <h4 style="color:white; color:window; font-family: arial; font-size: 20">21120116120007</h4>        
    </div>                
    </div>
</div>
<div class="container col-lg-4 col-md-4 col-sm-4 col-xs-4"></div>
